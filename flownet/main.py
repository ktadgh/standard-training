...
import flownet.models1 as models1, losses, datasets
...
if __name__ == '__main__':
    ...
    tools.add_arguments_for_module(parser, models1, argument_for_class='model', default='FlowNet2')
    ...
    with tools.TimerBlock("Parsing Arguments") as block:
        ...
        args.model_class = tools.module_to_dict(models1)[args.model]
