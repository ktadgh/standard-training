...
onnx_file_path = 'original-for-q.onnx'
...
# Load the ONNX model
model_path ='original-for-q.onnx'
...
onnx_file_path = 'original-for-q-shape.onnx'
import os 
cache_path = os.path.abspath('/home/ubuntu/transformer-distillation/cache')
...
# raise ValueError()
os.environ["ONNX_RUNTIME_TENSORRT_ENGINE_CACHE_PATH"] = cache_path
